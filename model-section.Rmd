...
Suppose that men's and women's attractiveness are given by
\begin{align*}
i(x) &= ax_1 + (1-a)x_2, \\
j(y) &= by_1 + (1-b)y_2
\end{align*}
respectively, with $0\le a \le 1$, $0 \le b \le 1$. Then children's characteristics $x^\prime_1$ and $x^\prime_2$  
will be positively correlated unless $a = b = 0$ or $a = b = 1$.
\end{claim}
