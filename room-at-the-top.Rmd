...
@heckman2013understanding, who decompose the average treatment
...
the relationship between genetic and economic variables. @benjamin2011promises
...
[@barth2020genetic; @papageorge2020genes; @ronda2020family].
...
characteristics.[^papers] While this may be tenable in within-generation
...
[^papers]: A small literature in economics examines
the relationship between genetic and economic variables. @benjamin2011promises
...
`r percent(coef_bo["University"], 1)` percentage points, income by about 
£`r pretty(coef_bo["Income"] * 1000)`, fluid IQ by about 
...
[^9]: The appendix reports results without controlling for mother's age.
...
interacted with a full set of family size dummies. None of the `r
n_within_coefs` birth order coefficients were significant at $p < 0.001$.
