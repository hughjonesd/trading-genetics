...
matching in marriage markets. @chiappori2012fatter show empirically that
body mass index and SES (specifically, earnings and education) are both
valued in a match. @oreffice2010anthropometry show that height and BMI
are associated with spouse earnings. @dupuy2014personality find spouse
...
@halsey1958genetics showed in a two-class model that social mobility
combined with assortative mating might increase the association between
genetics and social class. @belsky2018genetic offer three reasons for
