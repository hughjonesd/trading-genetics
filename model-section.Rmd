...
```{r pic-asymptotic-corr, fig.align = "center", fig.cap = "Long-run correlation between $x_1$ and $x_2$, by $a$ and $\\theta$. $\\tau$ = 0.95.", dpi = 300, out.height="3.5in"}
...
```{r pic-gamma, fig.align = "center", fig.cap = "Correlation between $x^\\prime_1$ and $x^\\prime_2$, by $a$ and $\\theta$ under meritocracy. $\\gamma$ = 0.15, $\\tau$ = 0.95, $s$ = $S$ = 1, $\\sigma$ = 0.", dpi = 300, out.height = "3.5in"}
