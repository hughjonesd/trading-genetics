...
A rich literature in genetics studies assortative mating. The most common model
is phenotypic assortative mating, where spouses match on phenotypes which are
related to genetics, to family environment (possibly including cultural inheritance
...
in individuals. Early empirical work used structural models to estimate parameters
from correlations between twins and spouses of twins. (XXX be precise) Since
the "genomics revolution", which has made individuals' DNA data directly available,
empirical research has focused on genetic assortative mating
...
contemporary human populations [@hugh2016assortative; @robinson2017genetic;
@howe2019genetic]. Other work has analysed cross-trait
assortative mating, when e.g. people with genes for height marry people with 
genes for intelligence [@Beauchamp_2010; @Sundet_2005; @border2022cross]. As a 
result, the two types of genetic variation become associated. 

We see our contribution as follows. First, our theoretical model links the economic
and genetic literatures, basing spouse matching on a micro-founded choice model. 
We focus specifically on the consequences of SGAM for inequality. In particular, 
we can relate economic policy parameters to the size of the genes-SES gradient.
Second, our research design gives us a clean pathway from environmental shocks
to a person's SES, to the genetic endowment of their spouse. 
