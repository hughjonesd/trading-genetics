...
```{r pic-asymptotic-inequality, fig.align = "center", fig.cap = "Meritocracy, assortative mating and economic inequality. Curves show equilibrium standard deviation of wealth $x_2$ for different parameter combinations.", fig.height = 3.5, fig.width = 3.5}
