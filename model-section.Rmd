...
```{r pic-asymptotic-corr, fig.align = "center", fig.cap = "Long-run correlation between $x_1$ and $x_2$, by $a$ and $\\theta$", dpi = 144}
...
# 
# um <- matrix(c(0.63775003,  -0.7701848, -0.009502447, 0,
#                0.04336312,   0.0235839,  0.998780727, 0,
#               -0.76902151,  -0.6373846,  0.048438177, 0,
#                0, 0, 0, 1), 
#              4, 4, byrow = TRUE)
invisible(rgl::open3d(
              userMatrix = rgl::rotate3d(rgl::r3dDefaults$userMatrix, 
                                         angle = 45, x = 0, y = 0, z = 1),
              zoom = 0.8
            ))
rgl::plot3d(
             Vectorize(corr),
...
children's characteristics, via environmental effects [@kong2018nature].
