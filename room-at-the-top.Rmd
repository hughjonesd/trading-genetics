...
Linearizing our model so that $A(g, s) = (1-k)g + ks$ and applying \@ref(eq:same-A) gives:

```{=tex}
\[
\frac{d g_{p(i)}}{d s_i} = \frac{k}{1-k}
\]
```

We wish to test whether $k > 0$. Doing so requires estimating $\frac{d g_p}{d s_i}$
