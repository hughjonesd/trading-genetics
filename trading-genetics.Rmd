...
*genes-SES gradient* -- the systematic genetic differences between high-
and low-SES people [@belsky2018genetic; @Rimfeld_2018;
@bjorklund2006origins]. The dominant existing explanation for the
...
associations [@howe2022within; @young2022mendelian]. This suggests there
is confounding from gene-environment correlation, and assortative mating
may play a role [@border2022cross]. (2) parental alleles which are *not*
transmitted to the child correlate with child outcomes
[@kong2018nature]. This could result from "genetic nurture", i.e.
...
[@young2023estimation; @nivard2024more]. (3) Correlations between spouses' 
...
@robinson2017genetic; @torvik2022modeling]. These results suggest that
...
structural model [@eaves1999comparing; @torvik2022modeling; 
@collado2023estimating]. Because both cultural and genetic inheritance
...
but not across generations.[^okbay] We take a different approach, by cleanly
...
correlations [@clark2015intergenerational; @barone2021intergenerational;
@solon2018we], and distant relatives in the same generation are also more
similar than parent-child and spousal correlations would predict
[@collado2023estimating]. @clark2023inheritance argues that this can be explained
...
increase *intergenerational mobility*, like mass education or
inheritance taxation, may affect not only economic but genetic
inequality. Conversely, an increase in *economic meritocracy* increases
the long-run association between SES and genetics,[^4] posing the
problem raised by @young1958rise and more recently
@markovits2019meritocracy: meritocracy may be self-limiting or even
self-undermining.

[^4]: See Proposition \@ref(prop-gamma) below.
