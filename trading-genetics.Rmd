...
abstract: |
  ...
  is endogenous to economic institutions. \par\textbf{Keywords:} Assortative mating, 
  MoBa, UK Biobank.
date: "`r Sys.Date()`"
output: 
...
[^language]: Throughout, "good genes" simply mean genetic variants
associated with characteristics considered desirable in a society's marriage
markets. No ethical valuation is implied.
